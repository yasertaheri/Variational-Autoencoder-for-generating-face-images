...
#               
      ...
      def decoder(self,Y): 
          ...
          with tf.variable_scope('decoder',reuse=None):
               W = tf.get_variable("weight",[self.hidden_1_n, 784], initializer = tf.random_normal_initializer(stddev=0.001))  
               b = tf.get_variable("bias",[1, 784], initializer = tf.zeros_initializer())
